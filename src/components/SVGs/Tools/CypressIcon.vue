...
const clipPathId = `cypress-clip-${instanceId}`;
const firstGradientId = `cypress-gradient-first-${instanceId}`;
const secondGradientId = `cypress-gradient-second-${instanceId}`;
</script>
...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100">
        ...
        <defs>
            ...
            >
                <stop offset=".094" stop-color="#58d09e" />
                <stop offset=".988" stop-color="#58d09e" stop-opacity="0" />
            </linearGradient>
            <linearGradient
                :id="secondGradientId"
                x1="2.466"
                ...
                gradientUnits="userSpaceOnUse"
            >
                <stop offset=".077" stop-color="#58d09e" />
                <stop offset=".762" stop-color="#1b1e2e" />
            </linearGradient>
